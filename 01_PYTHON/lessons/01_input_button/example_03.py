"""
=========================================================
* Lección 01: Pulsación corta vs larga
* Descripción: Distingue entre pulsaciones cortas y
* largas en GPIO17 para controlar el LED en GPIO18.
* - Corta: alterna LED.
* - Larga (>1.5s): apaga LED y muestra aviso.
=========================================================
"""
