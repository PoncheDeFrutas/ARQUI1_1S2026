"""
=========================================================
* Lección 01: Botón con detección de eventos y callback
* Descripción: Usa add_event_detect en GPIO17 (pull-up)
* para alternar el LED en GPIO18 sin hacer polling.
* Antirrebote se maneja con bouncetime (ms).
=========================================================
"""
